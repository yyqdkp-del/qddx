...
import { Heart, Palette, BookOpen, BookMarked, Library } from "lucide-react"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "道教文化 - 青岛市道教协会",
  description: "了解道教养生文化、道教艺术与经典导读，并结合青岛市本地化场景进行交流学习。",
}
        ...
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Link
              ...
              className="group flex flex-col gap-4 rounded-lg border border-border bg-card p-8 shadow-sm transition-all hover:border-accent/50 hover:shadow-md md:flex-row md:items-center"
            >
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground transition-colors group-hover:bg-accent group-hover:text-accent-foreground">
            ...
            >
              ...
              <div className="min-w-0 text-left">
                <h3 className="text-lg font-bold text-card-foreground group-hover:text-primary">经典导读</h3>
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  整理《道德经》等经典的公益讲座提要，以及与崂山文史相关的公开出版物线索，仅限合规学术交流。
                </p>
              </div>
            </Link>
          </div>
